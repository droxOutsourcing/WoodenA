...
export default function VietnamService() {
  return (
    <div className="w-full max-w-7xl mx-auto py-10 px-4">
      <section className="bg-[#43A047] rounded-xl p-6 mb-8">
        <h1 className="text-2xl font-bold text-white mb-2">베트남 현지 서비스 <span className="text-base font-normal align-middle ml-2 text-white/80">Vietnam Local Services</span></h1>
      ...
      <div className="flex gap-2 mb-6">
        <button className="px-4 py-2 border rounded bg-white text-[#222] font-semibold">건강보험 공단 제출</button>
        <button className="px-4 py-2 border rounded bg-white text-[#222] font-semibold">법인 설립·노동허가·거주증</button>
        <button className="px-4 py-2 border rounded border-[#43A047] text-[#43A047] font-semibold">기타 현지 지원</button>
      </div>
      <section className="mb-8">
        <h2 className="text-xl font-bold mb-4">기타 현지 지원</h2>
      ...
      <section className="w-full bg-[#43A047] py-8 mt-8 rounded-xl">
